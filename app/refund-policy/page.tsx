...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    locale: "en_UG",
    url: "https://mirrorsiteai.vercel.app/refund-policy",
    siteName: "MirrorSite AI",
    title: "MirrorSite AI Refund Policy | Credit Purchases & Refunds",
    description:
      "Learn about MirrorSite AI's refund policy for credit purchases, mobile money payments, failed transactions, and account credits.",
    images: [{ url: "/hero/og-image.png", width: 1200, height: 630, alt: "MirrorSite AI Refund Policy" }],
  },
  twitter: {
        ...
        <footer className="border-t border-border">
          <div className="mx-auto flex w-full max-w-7xl flex-col gap-5 px-6 py-8 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between lg:px-10">
            ...
            <div className="flex flex-wrap gap-x-5 gap-y-2">
              ...
              <Link href="/refund-policy" className="text-foreground">Refunds</Link>
