...
import { Rocket, Shield, CreditCard, Sparkles, ArrowRight, Code2, Palette, Lightbulb, Zap } from "lucide-react"
  ...
  return (
    <div className="relative">
      ...
      <div className="mb-10 space-y-4">
        {[
          { step: "1", title: "Sign up in seconds", desc: "Google or email — your choice. Instant access, no waiting." },
          { step: "2", title: "Describe your app", desc: "Paste a URL or describe your idea. Our AI does the heavy lifting." },
          { step: "3", title: "Ship to production", desc: "One click and your app is live with HTTPS, CDN, and a custom domain." },
        ].map((item) => (
          <div key={item.step} className="auth-step-item flex items-start gap-4">
