...
import { ArrowRight, BookOpen, Code2, Compass, Globe, Lightbulb, Rocket, Shield, Zap, CreditCard, Settings, HelpCircle, FileText, CheckCircle2, ArrowLeft, Users, Upload, Puzzle, BarChart3 } from "lucide-react"
...
const sections = [
  ...
  { id: "website-mode", label: "Website Mode", icon: Globe },
  { id: "idea-mode", label: "Idea Mode", icon: Lightbulb },
  { id: "understanding", label: "Understanding & Planning", icon: Compass },
  { id: "editing-your-plan", label: "Editing Your Plan", icon: FileText },
  { id: "building", label: "Building Your Application", icon: Code2 },
  { id: "workspace", label: "Working With Your App", icon: Puzzle },
  { id: "publishing", label: "Publishing & Domains", icon: Upload },
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-b border-border bg-card/40">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          <Link href="/resources" className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-muted-foreground transition-colors hover:text-foreground mb-6">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-muted-foreground">
            Step-by-step guides, detailed explanations, and answers to common questions. Learn how to turn any website or idea into a working application.
          </p>
        </div>
      </section>
        ...
        <div className="prose-custom max-w-3xl space-y-16">
          ...
          <section id="website-mode">
            ...
            <div className="space-y-6 text-muted-foreground leading-7">
              ...
              <p>
                When MirrorSite AI analyzes a website, it looks at:
              </p>
              <ul className="space-y-2">
          ...
          <section id="workspace">
            ...
            <div className="space-y-6 text-muted-foreground leading-7">
              ...
              <p>
                Use the instruction bar to describe changes in plain language. MirrorSite AI will implement them for you. Some examples:
              </p>
          ...
          <section id="credits">
            ...
            <div className="space-y-6 text-muted-foreground leading-7">
              ...
              <p>
                The build cost depends on the complexity of your application. MirrorSite AI automatically classifies your project into one of three tiers:
              </p>
              <ul className="space-y-2">
