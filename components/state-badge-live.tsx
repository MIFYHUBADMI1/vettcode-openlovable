...
const COLORS: Record<ProjectState, string> = {
  ...
  plan_ready: "border-primary/60 bg-primary/15 text-primary font-semibold",
  pending_plan: "border-amber-500/40 bg-amber-500/10 text-amber-600 dark:text-amber-400",
