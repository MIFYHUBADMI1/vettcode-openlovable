...
function validateQueryInput(input: DbQueryInput): void {
...
function validateCreateInput(input: DbCreateInput): void {
  if (input === null || typeof input !== "object") {
...
function validateEditInput(input: DbEditInput): void {
  if (input === null || typeof input !== "object") {
...
function validateDeleteInput(input: DbDeleteInput): void {
  if (input === null || typeof input !== "object") {
...
export class DatabaseCapability {
  ...
  async query(input: DbQueryInput, options?: AtaiRequestOptions): Promise<DbQueryResult> {
    ...
    const { envelope } = await execute<typeof body, DbQueryResult>(this.config, {
      path: "",
      method: "POST",
      body,
      options,
  ...
  async create(input: DbCreateInput, options?: AtaiRequestOptions): Promise<DbCreateResult> {
    ...
    const { envelope } = await execute<typeof body, DbCreateResult>(this.config, {
      path: "",
      method: "POST",
      body,
      options,
  ...
  async edit(input: DbEditInput, options?: AtaiRequestOptions): Promise<DbEditResult> {
    ...
    const { envelope } = await execute<typeof body, DbEditResult>(this.config, {
      path: "",
      method: "POST",
      body,
      options,
  ...
  async delete(input: DbDeleteInput, options?: AtaiRequestOptions): Promise<DbDeleteResult> {
    ...
    const { envelope } = await execute<typeof body, DbDeleteResult>(this.config, {
      path: "",
      method: "POST",
      body,
      options,
...
function assertQueryResult(payload: unknown): DbQueryResult {
  if (typeof payload !== "object" || payload === null || !Array.isArray((payload as Record<string, unknown>).records)) {
    throw new AtaiError("atai_invalid_response", "The Atai Runtime API returned an unexpected response shape.")
  }
  return payload as unknown as DbQueryResult
}

function assertCreateResult(payload: unknown): DbCreateResult {
  ...
  return payload as unknown as DbCreateResult
}

function assertEditResult(payload: unknown): DbEditResult {
  if (typeof payload !== "object" || payload === null) {
    throw new AtaiError("atai_invalid_response", "The Atai Runtime API returned an unexpected response shape.")
  }
  const p = payload as Record<string, unknown>
  ...
  return payload as unknown as DbEditResult
}

function assertDeleteResult(payload: unknown): DbDeleteResult {
  if (typeof payload !== "object" || payload === null || (payload as Record<string, unknown>).success !== true) {
    throw new AtaiError("atai_invalid_response", "The Atai Runtime API returned an unexpected response shape.")
  }
  return payload as unknown as DbDeleteResult
}
